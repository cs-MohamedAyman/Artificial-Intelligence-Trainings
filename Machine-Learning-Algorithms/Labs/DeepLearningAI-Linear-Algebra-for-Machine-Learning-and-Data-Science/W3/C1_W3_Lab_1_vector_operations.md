...
```
    ...
    Dot product:  249828.40296090973
    Time for the loop version:342.4360752105713 ms
...
```
    ...
    Dot product:  249828.40296090973
    Time for the vectorized version, np.dot() function: 1.6856193542480469 ms
...
```
    ...
    Dot product:  249828.40296090973
    Time for the vectorized version, @ function: 1.651763916015625 ms
