...
- [`tf.keras.optimizers.Adam`](https://tensorflow.org/api_docs/python/tf/keras/optimizers/Adam)
- [`tf.keras.optimizers.SGD`](https://tensorflow.org/api_docs/python/tf/keras/optimizers/SGD) with a momentum of 0.9
