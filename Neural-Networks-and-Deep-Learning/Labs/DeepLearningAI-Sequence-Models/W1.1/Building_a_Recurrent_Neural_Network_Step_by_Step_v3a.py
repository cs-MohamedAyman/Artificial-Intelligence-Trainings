...
#     * Specifically, review the week 2 assignment ["Python Basics with numpy (optional)"](https://coursera.org/learn/neural-networks-deep-learning/item/Zh0CU).
#
#
...
#
# #### Additional Hints
# * [numpy.tanh](https://google.com/search?q=numpy+tanh&rlz=1C5CHFA_enUS854US855&oq=numpy+tanh&aqs=chrome..69i57j0l5.1340j0j7&sourceid=chrome&ie=UTF-8)
...
def lstm_forward(x, a0, parameters):
    ...
    a_next = a0
    c_next = np.zeros((n_a,m), dtype=np.float)
...
#
# It may be worthwhile to review Course 1 [Derivatives with a computational graph](https://coursera.org/learn/neural-networks-deep-learning/lecture/0VSHe/derivatives-with-a-computation-graph)  through  [Backpropagation Intuition](https://coursera.org/learn/neural-networks-deep-learning/lecture/6dDj7/backpropagation-intuition-optional), which decompose the calculation into steps using the chain rule.
...
def lstm_cell_backward(da_next, dc_next, cache):
    ...
    dc_prev = (dc_next * ft) + (ot * (1.0 - np.square(np.tanh(c_next))) * ft * da_next)
