# -*- coding: utf-8 -*-
"""C4_W4_Lab_3_CelebA_GAN_Experiments.ipynb
...
You will use a TPU and its corresponding [distribution strategy](https://tensorflow.org/api_docs/python/tf/distribute/TPUStrategy) to speed up the training. We've provided the setup code and helper functions below. You might recognize some of these from taking Course 2 of this Specialization.
"""
