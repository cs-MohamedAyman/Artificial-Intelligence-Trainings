...
```
    ...
    <ipython-input-8-58a4c002f41d> in <module>
          1 # Detect hardware
          2 try:
...
```
    ...
    environ{'WORKSPACE_ENV_VARS': 'WORKSPACE_ID,COURSE_ID,SUBMISSION_TOKEN,WORKSPACE_TYPE,WORKSPACE_MODE,PROXY_IMPROVEMENT',
            'LC_ALL': 'en_US.UTF-8',
            'WORKSPACE_ID': 'ppkhttgf',
            'WORKSPACE_TYPE': 'student',
            'LANG': 'en_US.UTF-8',
            'HOSTNAME': '24e9b0eab61e',
            'NB_UID': '1000',
            'CONDA_DIR': '/opt/conda',
            'CONDA_VERSION': '4.8.2',
            ...
            'COURSE_ID': 'rsE-F_PIEeqdDRIRGqcDrw',
            'SUBMISSION_TOKEN': '5GHvitPT8nyJHpgxJ5y1',
...
```
    ...
    <ipython-input-4-d963cd0210b1> in <module>
    ----> 1 inference_model = model
