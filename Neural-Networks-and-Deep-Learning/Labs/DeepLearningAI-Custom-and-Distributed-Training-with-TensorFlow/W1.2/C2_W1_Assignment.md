...
In this graded assignment, you will perform different tensor operations as well as use [GradientTape](https://tensorflow.org/api_docs/python/tf/GradientTape). These are important building blocks for the next parts of this course so it's important to master the basics. Let's begin!
...
## Exercise 1 - [tf.constant]((https://tensorflow.org/api_docs/python/tf/constant))
...
## Exercise 2 - [tf.square](https://tensorflow.org/api_docs/python/tf/math/square)
...
## Exercise 3 - [tf.reshape](https://tensorflow.org/api_docs/python/tf/reshape)
...
## Exercise 4 - [tf.cast](https://tensorflow.org/api_docs/python/tf/cast)
...
## Exercise 5 - [tf.multiply](https://tensorflow.org/api_docs/python/tf/multiply)
...
## Exercise 6 - [tf.add](https://tensorflow.org/api_docs/python/tf/add)
...
You can review the [docs](https://tensorflow.org/api_docs/python/tf/GradientTape) or revisit the lectures to complete this task.
